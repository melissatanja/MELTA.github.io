...
$('#col_8c4119').hover(function(){
	...
	$('#image1').css('background-image', 'url("images/image1.jpg")');
	
})

$('#col_a9c1ee').hover(function(){
...
$('#col_776244').hover(function(){

	$('#image2').css('background-image', 'url("images/image2_776244.jpg")');
	}, function(){
	$('#image2').css('background-image', 'url("images/image2.jpg")');
	
})

$('#col_abb4bf').hover(function(){
...
$('#col_4c6047').hover(function(){

	$('#image3').css('background-image', 'url("images/image3_4c6047.jpg")');
	}, function(){
	$('#image3').css('background-image', 'url("images/image3.jpg")');
	
})

$('#col_6d503e').hover(function(){
...
$('#col_5bd5ff').hover(function(){

	$('#image4').css('background-image', 'url("images/image4_5bd5ff.jpg")');
	}, function(){
	$('#image4').css('background-image', 'url("images/image4.jpg")');
	
})

$('#col_15110e').hover(function(){
...
$('#col_788f9e').hover(function(){

	$('#image5').css('background-image', 'url("images/image5_788f9e.jpg")');
	}, function(){
	$('#image5').css('background-image', 'url("images/image5.jpg")');
	
})

$('#col_374454').hover(function(){
...
$('#col_435a15').hover(function(){

	$('#image6').css('background-image', 'url("images/image6_435a15.jpg")');
	}, function(){
	$('#image6').css('background-image', 'url("images/image6.jpg")');
	
})

$('#col_ffffff').hover(function(){
...
$('#col_a0a0ac').hover(function(){

	$('#image7').css('background-image', 'url("images/image7_a0a0ac.jpg")');
	}, function(){
	$('#image7').css('background-image', 'url("images/image7.jpg")');
	
})

$('#col_a7956c').hover(function(){
...
$('#col_f67767').hover(function(){

	$('#image8').css('background-image', 'url("images/image8_f67767.jpg")');
	}, function(){
	$('#image8').css('background-image', 'url("images/image8.jpg")');
	
})

$('#col_fdc300').hover(function(){
...
$('#col_b26062').hover(function(){

	$('#image9').css('background-image', 'url("images/image9_b26062.jpg")');
	}, function(){
	$('#image9').css('background-image', 'url("images/image9.jpg")');
	
})

$('#col_94161b').hover(function(){
...
$('#col_232f5d').hover(function(){

	$('#image10').css('background-image', 'url("images/image10_232f5d.jpg")');
	}, function(){
	$('#image10').css('background-image', 'url("images/image10.jpg")');
	
})

$('#col_dfd1c8').hover(function(){
...
$('#col_5a393f').hover(function(){

	$('#image11').css('background-image', 'url("images/image11_5a393f.jpg")');
	}, function(){
	$('#image11').css('background-image', 'url("images/image11.jpg")');
	
})

$('#col_b5958a').hover(function(){
...
$('#col_253d47').hover(function(){

	$('#image12').css('background-image', 'url("images/image12_253d47.jpg")');
	}, function(){
	$('#image12').css('background-image', 'url("images/image12.jpg")');
	
})

$('#col2_ffffff').hover(function(){
...
$('#col_406784').hover(function(){

	$('#image13').css('background-image', 'url("images/image13_406784.jpg")');
	}, function(){
	$('#image13').css('background-image', 'url("images/image13.jpg")');
	
})

$('#col_e1dbc3').hover(function(){
...
$('#col_564e42').hover(function(){

	$('#image14').css('background-image', 'url("images/image14_564e42.jpg")');
	}, function(){
	$('#image14').css('background-image', 'url("images/image14.jpg")');
	
})

$('#col_7689ad').hover(function(){
...
$('#col_a48557').hover(function(){

	$('#image15').css('background-image', 'url("images/image15_a48557.jpg")');
	}, function(){
	$('#image15').css('background-image', 'url("images/image15.jpg")');
	
})

$('#col_9ba3ad').hover(function(){
...
$('#col_2f84d0').hover(function(){

	$('#image16').css('background-image', 'url("images/image16_2f84d0.jpg")');
	}, function(){
	$('#image16').css('background-image', 'url("images/image16.jpg")');
	
})

$('#col_6c5445').hover(function(){
...
$('#col_4e7477').hover(function(){

	$('#image17').css('background-image', 'url("images/image17_4e7477.jpg")');
	}, function(){
	$('#image17').css('background-image', 'url("images/image17.jpg")');
	
})

$('#col_c7d29e').hover(function(){
...
$('#col_555346').hover(function(){

	$('#image18').css('background-image', 'url("images/image18_555346.jpg")');
	}, function(){
	$('#image18').css('background-image', 'url("images/image18.jpg")');
	
})

$('#col_eef2fd').hover(function(){
...
$('#col_9e8857').hover(function(){

	$('#image19').css('background-image', 'url("images/image19_9e8857.jpg")');
	}, function(){
	$('#image19').css('background-image', 'url("images/image19.jpg")');
	
})

$('#col_4b1f18').hover(function(){
